<template>
    <div class="error-root">
        ...
        <h1 class="title">Looks like this cup<br>is empty</h1>
        <p class="subtitle">The page you're looking for has gone cold.</p>

        <div class="divider" />

        <button class="btn-home" @click="handleError">Back to home</button>
    </div>
</template>
